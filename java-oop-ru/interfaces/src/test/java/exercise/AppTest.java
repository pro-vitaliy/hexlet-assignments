...
class AppTest {
    ...
    @Test
    void testLength() {
        ReversedSequence sequence = new ReversedSequence("ytrewq");
    ...
    void testCharAt() {
        ReversedSequence sequence = new ReversedSequence("ytrewq");
        assertThat(sequence.charAt(0)).isEqualTo('q');
        assertThat(sequence.charAt(5)).isEqualTo('y');
    }

    @Test
    void testSubSequence() {
        ReversedSequence sequence = new ReversedSequence("ytrewq");
        assertThat(sequence.subSequence(1, 3)).isEqualTo("we");
    }

    @Test
    void testToString() {
        ReversedSequence sequence = new ReversedSequence("ytrewq");
        assertThat(sequence.toString()).isEqualTo("qwerty");
    }
    // END
}
